...
skel.registerPlugin("layers", function (e) {
    ...
    var t, n = "config", r = "_skel_layers_translateOrigin", i = "cache", s = "$element", o = "_skel_layers_translate",
        u = "_skel_layers_resetForms", f = "_skel_layers_resume", l = "_skel_layers_promote", c = "exclusiveLayer",
        h = "activeWrapper", p = "moveToInactiveWrapper", d = "_skel_layers_demote", v = "moveToActiveWrapper",
        m = "setTimeout", g = "right", y = "bottom", b = "useActive", w = "scrollTop", E = "deactivate", S = "css",
        x = "width", T = "center", N = "_skel_layers_suspend", C = "position", k = "prototype", L = null, A = "left",
        O = "wrapper", M = "skel-layers-layer-z-index", _ = "_skel_layers_init", D = "children", P = !1,
        H = "inactiveWrapper", B = "top", j = "deviceType", F = "length", I = "height",
        q = "touchstart.lock click.lock scroll.lock", R = "window", U = "transform", z = "element",
        W = "stopPropagation", X = "resetForms", V = "preventDefault", $ = "overflow-x", J = "recalcW", K = "-webkit-",
        Q = "padding-bottom", G = "-webkit-tap-highlight-color", Y = "isInitialized", Z = "skel_layers_inactiveWrapper",
        et = "originalEvent", tt = "animation", nt = "touchPosY", rt = "touchPosX", it = "skel-layers-layer-position",
        st = "skel-layers-layer-index", ot = "z-index", ut = "unlockView", at = "animations",
        ft = '<div id="skel-layers-tmp-', lt = "hidden", ct = "_skel_layers_initializeCell",
        ht = "resize.lock scroll.lock", pt = "find", dt = "registerLocation", vt = "orientationchange.lock",
        mt = "none", gt = "activate", yt = "speed", bt = "positions", wt = "-moz-", Et = "_skel_layers_expandCell",
        St = "_skel_layers_hasParent", xt = "attr", Tt = "layers", Nt = "append", Ct = "lockView", kt = !0,
        Lt = "#skel-layers-tmp-", At = "-ms-", Ot = "isTouch", Mt = "DOMReady", _t = "_skel_layers_scrollPos",
        Dt = "auto", Pt = "_skel_layers_xcss", Ht = "visible", Bt = "-o-", jt = "transformBreakpoints", Ft = "iterate",
        It = "rgba(0,0,0,0)", qt = "appendTo", Rt = "cell-size", Ut = "vars", zt = "active", Wt = "px", Xt = "-",
        Vt = "body", $t = "click", Jt = "touches", Kt = "overflow-", Qt = "isVisible", Gt = "side", Yt = "recalcH",
        Zt = "relative", en = "android", tn = "transformTest", nn = "pointer", rn = "#", sn = "getArray", on = "*";
    return typeof e == "undefined" ? P : (e.fn[St] = function () {
        ...
        config: {baseZIndex: 1e4, transform: kt, transformBreakpoints: L, transformTest: L, speed: 250, layers: {}},
        cache: {layers: {}, body: L, window: L, wrapper: L, inactiveWrapper: L, activeWrapper: L, exclusiveLayer: L},
        eventType: $t,
        ...
        parseInit: function (n) {
            var r, s, o = n.get(0), u = n[xt]("data-action"), a = n[xt]("data-args"), l, h;
            u && a && (a = a.split(","));
            switch (u) {
                case"toggleLayer":
                case"layerToggle":
            ...
            if (t[n][U]) e.fn[r] = function () {
                ...
                t[i][R].resize(function () {
                    ...
                    for (o = 0; o < this[F]; o++) {
                        ...
                        if (!u[h.id]) if (d = un[k][bt][p.data(it)]) {
                            u[h.id] = {};
                            switch (d.v) {
                                case T:
                                case B:
                        ...
                        } else d = p[C](), u[h.id] = {top: d[B], left: d[A]};
